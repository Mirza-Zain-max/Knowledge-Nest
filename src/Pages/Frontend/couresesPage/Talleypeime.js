...
import img from '../../../asset/Courses/tallyprime.png'
            ...
            <main>
                <section className='py-5 px-sm-0 px-lg-5 bg-gray-200'>
                    <Container>
                        <Row>
                            <Col span={24}>
                                <div className='text-black text-3xl sm:text-5xl font-semibold text-center w-2/3 mx-auto'>Tally Prime Course</div>
                            ...
                            <Col xs={24} sm={24} md={16} lg={13}>
                                <div className="card bg-white rounded-3 shadow-lg ">
                                    ...
                                    <div className="body py-3 px-4">
                                        <p className='text-justify fs-2 py-2 text-red-600'>About Tally Prime Course.</p>
                                        <p className='text-justify text-lg pt-2'>This Tally Prime course is for those students who want to go into account field in their future. <br />
                                            In Accounts field we learn to create vouchers for sale, purchase, sale return and purchase return and there are many more topics that you will learn in Tally ERP 9 and Accounts. <br />
                                            And if you are a student of commerce background then you can learn Tally Prime very easily. <br />
                                            Tally Prime is an accounting software that works to manage the transactions of our company. <br />
                                            So if you also want to do Tally Prime course then by clicking on the below button you can start Tally course and learn. <br />
                                            So if you like this course, then share this course with your friends.</p>
                                    </div>
                                </div>
                            </Col>
                        </Row>
                        ...
                        {isModel && (
                            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 mx-3">
                                <div className="bg-white rounded-lg p-6 w-full max-w-md">
                                    ...
                                    "Currently, there is no video available for this <i className='font-bold'>'Tally Prime'</i> courses. It will be added soon. Thanks!  &#128522;"
                                    </div>
