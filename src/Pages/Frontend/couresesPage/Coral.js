...
import img from '../../../asset/Courses/core.png'
            ...
            <main>
                <section className='py-5 px-sm-0 px-lg-5 bg-gray-200'>
                    <Container>
                        <Row>
                            <Col span={24}>
                                <div className='text-black text-3xl sm:text-5xl font-semibold text-center w-2/3 mx-auto'>Corel Draw Course</div>
                                <p className='text-xl text-muted pt-2 text-center'> Learn Corel Draw Full Course For Become a Graphic Designer</p>
                            </Col>
                        </Row>
                        <Row className='pt-5'>
                            <Col xs={24} sm={24} md={16} lg={13}>
                                <div className="card bg-white rounded-3 shadow-lg ">
                                    ...
                                    <div className="body py-3 px-4">
                                        <p className='text-justify fs-2 py-2 text-red-600'>About Corel Draw Course</p>
                                        <p className='text-justify text-lg pt-2'> Corel Draw is a type of Vector and  Graphic Software. It is use for creating a designs, banner, visiting card and all the printing items.</p>
                                        <p className='text-justify fs-3 py-2 text-red-600  '>Corel Draw Course Syllabus</p>
                                        <ul className='pt-2 ms-4 list-disc text-lg'>
                                           <li>Intro to Corel Draw</li>
                                           <li>Use of all tools</li>
                                           <li>Working on Banners</li>
                                ...
                                <div className="card rounded-3 shadow-lg">
                                    ...
                                    <div className="card-body space-y-3">
                                        <div className='flex space-x-2 fs-6 items-center'>
                                            <FontAwesomeIcon className='text-green-600 pe-3 fs-4' icon={faMoneyBill1} />Rs.0.00 <del className='pe-2' >Rs.1900</del> | <span className='text-red-500'>100% Off </span>
                                        </div>
                                        <div className='flex space-x-2 fs-6 items-center'>
                                            <FontAwesomeIcon className='text-gray-600 pe-3 fs-4' icon={faClock} />1.5 Months Duration
                                        </div>
                                        <div className='flex space-x-2 fs-6 items-center'>
                        ...
                        {isModel && (
                            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 mx-3">
                                <div className="bg-white rounded-lg p-6 w-full max-w-md">
                                    ...
                                    "Currently, there is no video available for this <i className='font-bold'>'Coral Draw'</i> courses. It will be added soon. Thanks!  &#128522;"
                                    </div>
