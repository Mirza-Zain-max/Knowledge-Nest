...
import img from '../../../asset/Courses/web.png'
            ...
            <main>
                <section className='py-5 px-sm-0 px-lg-5 bg-gray-200'>
                    <Container>
                        <Row>
                            <Col span={24}>
                                <div className='text-black text-3xl sm:text-5xl font-semibold text-center w-2/3 mx-auto'>Web Development Course</div>
                                <p className='text-xl text-muted pt-2 text-center'> Become Full Stack Developer</p>
                            </Col>
                        </Row>
                        <Row className='pt-5'>
                            <Col xs={24} sm={24} md={16} lg={13}>
                                <div className="card bg-white rounded-3 shadow-lg ">
                                    ...
                                    <div className="body py-3 px-4">
                                        <p className='text-justify text-red-500 fs-2'>About Web Development Course.</p>
                                        <p className='text-justify fs-6 py-2'>This web development course is beginner to advanced level, in this course you will be learn how to make a website After doing this course you can create any type of website</p>
                                        ...
                                        <p className='text-justify fs-6 py-2'>If you face any problem while doing this course then you can call us and get your problems solved.</p>
                                        <p className='text-justify fs-6 py-2'>After doing this course you will easily get the job of website developer.</p>
                                        <div>
                                            <p className='text-justify fs-6'>In this course you will be Learn</p>
                                            ...
                                            <p className='text-justify fs-6 pt-3'>So if you like this course, then share this course with your friends.</p>
                                        </div>
                                    </div>
                                </div>
                            </Col>
                                ...
                                <div className="card rounded-3 shadow-lg">
                                    ...
                                    <div className="card-body space-y-3">
                                        <div className='flex space-x-2 fs-6 items-center'>
                                            <FontAwesomeIcon className='text-green-600 pe-3 fs-4' icon={faMoneyBill1} />Rs.0.00 <del className='pe-2' >Rs.6000</del> | <span className='text-red-500'>100% Off </span>
                                        </div>
                                        <div className='flex space-x-2 fs-6 items-center'>
                            ...
                            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 mx-3">
                                <div className="bg-white rounded-lg p-6 w-full max-w-md">
                                    ...
                                    <div className='text-lg pb-2 text-justify'>
                                        "Currently, there is no video available for this <i className='font-bold'>'Web Development'</i> courses. It will be added soon. Thanks!  &#128522;"
                                    </div>
