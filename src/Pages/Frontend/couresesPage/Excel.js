...
import img from '../../../asset/Courses/excel.png'
            ...
            <main>
                <section className='py-5 px-sm-0 px-lg-5 bg-gray-200'>
                    <Container>
                        <Row>
                            <Col span={24}>
                                <div className='text-black text-3xl sm:text-5xl font-semibold text-center w-2/3 mx-auto'>Advance Excel Course</div>
                                <p className='text-xl text-muted pt-2 text-center'>Learn All the Advance Excel Skills With Practical Videos & Notes.</p>
                            </Col>
                        </Row>
                        <Row className='pt-5'>
                            <Col xs={24} sm={24} md={16} lg={13}>
                                <div className="card bg-white rounded-3 shadow-lg ">
                                    ...
                                    <div className="body py-3 px-4">
                                        <p className='text-justify fs-2 text-red-500'>About Advance Excel Course.</p>
                                        <p className='text-justify fs-6 py-2'>Advance  Excel course is for all students because in this course Excel has been taught from basic to advanced.</p>
                                        <p className='text-justify fs-6 py-2'>In this course you will learn all these things</p>
                                        <div>
                                        ...
                                        <p className='text-justify fs-6 pt-2'>After doing this  computer course, you will be able to get many more jobs like data entry, stock management, data management.</p>
                                        <p className='text-justify fs-6 pt-2'>Anyone can easily do this advance excel course online sitting at home.</p>
                                        <p className='text-justify fs-6 py-2'>Anyone can easily do this advance excel course online sitting at home.</p>
                                    </div>
                                </div>
                            </Col>
                        </Row>
                        ...
                        {isModel && (
                            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 mx-3">
                                <div className="bg-white rounded-lg p-6 w-full max-w-md">
                                    ...
                                    "Currently, there is no video available for this <i className='font-bold'>'Excel'</i> courses. It will be added soon. Thanks!  &#128522;"
                                    </div>
