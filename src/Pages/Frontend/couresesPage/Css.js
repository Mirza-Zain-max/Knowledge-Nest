...
import img from '../../../asset/Courses/css.png'
            ...
            <main>
                <section className='py-5 px-sm-0 px-lg-5 bg-gray-200'>
                    <Container>
                        <Row>
                            <Col span={24}>
                                <div className='text-black text-3xl sm:text-5xl font-semibold text-center w-2/3 mx-auto'>CSS Course</div>
                                <p className='text-xl text-muted pt-2 text-center'>Design Your Website Using CSS.</p>
                            </Col>
                        </Row>
                        <Row className='pt-5'>
                            <Col xs={24} sm={24} md={16} lg={13}>
                                <div className="card bg-white rounded-3 shadow-lg ">
                                    ...
                                    <div className="body py-3 px-4">
                                        <p className='text-justify fs-2 text-red-500'>About CSS</p>
                                        <p className='text-justify fs-6 py-2'>CSS is a Cascading Style Sheet</p>
                                        ...
                                        <p className='text-justify fs-2 text-red-500'>Course Syllabus</p>
                                            <ul className='list-disc ms-4'>
                                             <li>Ch-1 Introduction to CSS2</li>
                                             <li>Ch-2 CSS2 Web layout design with sementic elements</li>
                                             <li>Ch-3 Web layout design with Inline stylesheet</li>
                                             <li>Ch-4 CSS2 Internal Stylesheet</li>
                                             <li>Ch-5 CSS2 Text & Dimensional Properties</li>
                                             <li>Ch-6 CSS2 Selectors</li>
                                             <li>Ch-7 Sweetshop Project part 1</li>
                                             <li>Ch-7 Sweetshop Project part 2</li>
                                             <li>Ch-7 Sweetshop Project part 3</li>
                                             <li>Ch-7 Sweetshop Project part 4</li>
                                             <li>Ch-7 Sweetshop Project part 5</li>
                                             <li>Ch-7 Sweetshop Project part 6</li>
                                             <li>Ch-7 Sweetshop Project part 7</li>
                                             <li>Ch-8 External Stylesheet & Background Poperties</li>
                                             <li>Ch-9 Metadata Installation with beautyproducts.com</li>
                                             <li>Ch-10 Beauty products Project part 1</li>
                                             <li>Ch-10 Beauty products Project part 2</li>
                                             <li>Ch-10 Beauty products Project part 3</li>
                                             <li>Ch-10 Beauty products Project part 4</li>
                                             <li>Ch-11 CSS2 Properties List part 1</li>
                                             <li>Ch-11 CSS2 Properties List part 2</li>
                                             <li>Ch-12 CSS2 Pseudo Class</li>
                                             <li>Ch-13 Complete Pseudo Classes</li>
                                             <li>Ch-14 CSS2 Position Properties</li>
                                             <li>Ch-15 CSS2 Dropdown Introduction</li>
                                             <li>Ch-16 CSS2 Dropdown Menu</li>
                                             <li>Ch-17 CSS2 Miscellaneous selectors and properties</li>
                                             <li>Ch-18 Opacity & Pseudo Element</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="card rounded-3 shadow-lg">
                                    ...
                                    <div className="card-body space-y-3">
                                        <div className='flex space-x-2 fs-6 items-center'>
                                            <FontAwesomeIcon className='text-green-600 pe-3 fs-4' icon={faMoneyBill1} />Rs.0.00 <del className='pe-2' >Rs.1000</del> | <span className='text-red-500'>100% Off </span>
                                        </div>
                                        <div className='flex space-x-2 fs-6 items-center'>
                        ...
                        {isModel && (
                            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 mx-3">
                                <div className="bg-white rounded-lg p-6 w-full max-w-md">
                                    ...
                                    "Currently, there is no video available for this <i className='font-bold'>'CSS'</i> courses. It will be added soon. Thanks!  &#128522;"
                                    </div>
