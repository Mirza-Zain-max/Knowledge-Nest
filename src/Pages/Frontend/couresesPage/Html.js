...
import img from '../../../asset/Courses/html.png'
            ...
            <main>
                <section className='py-5 px-sm-0 px-lg-5 bg-gray-200'>
                    <Container>
                        <Row>
                            <Col span={24}>
                                <div className='text-black text-3xl sm:text-5xl font-semibold text-center w-2/3 mx-auto'>HTML Course</div>
                                <p className='text-xl text-muted pt-2 text-center'>Learn HTML Complete Course with Live Projects</p>
                            </Col>
                        </Row>
                        <Row className='pt-5'>
                            <Col xs={24} sm={24} md={16} lg={13}>
                                <div className="card bg-white rounded-3 shadow-lg ">
                                    ...
                                    <div className="body py-3 px-4">
                                        <p className='text-justify fs-2 text-red-500'>About HTML Course.</p>
                                        <p className='text-justify fs-6 py-2'>This HTML course is for those students who want to go into website development field in their future.</p>
                                        <p className='text-justify fs-6 py-2'>Website development is a trending course in today time because in today time all businesses are going online and a website is the only support in taking those businesses online.</p>
                                        <p className='text-justify fs-6 py-2'>And for this reason website development has become a trending course.</p>
                                        <p className='text-justify fs-6 py-2'>If you want to start in website development field, then website development field starts with HTML language.</p>
                                        <p className='text-justify fs-6 py-2'>And you can learn HTML very easily.</p>
                                        <p className='text-justify fs-6 py-2'>HTML is a hypertext markup language which creates web pages.</p>
                                        <p className='text-justify fs-6 py-2'>So if you also want to do HTML course, then by clicking on the button given below you can learn HTML.</p>
                        ...
                        {isModel && (
                            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 mx-3">
                                <div className="bg-white rounded-lg p-6 w-full max-w-md">
                                    ...
                                    "Currently, there is no video available for this <i className='font-bold'>'HTML'</i> courses. It will be added soon. Thanks!  &#128522;"
                                    </div>
