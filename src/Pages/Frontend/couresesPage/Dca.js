...
import img from '../../../asset/Courses/dca.png'
            ...
            <main>
                <section className='py-5 px-sm-0 px-lg-5 bg-gray-200'>
                    <Container>
                        <Row>
                            <Col span={24}>
                                <div className='text-black text-3xl sm:text-5xl font-semibold text-center w-2/3 mx-auto'>DCA Course</div>
                                <p className='text-xl text-muted pt-2 text-center'>DCA, Diploma In Computer Application, Learn Full DCA Course in Urdu</p>
                            </Col>
                        </Row>
                        <Row className='pt-5'>
                            <Col xs={24} sm={24} md={16} lg={13}>
                                <div className="card bg-white rounded-3 shadow-lg ">
                                    ...
                                    <div className="body py-3 px-4">
                                        <p className='text-justify fs-2 py-2 text-red-600'>Full Form of DCA in Computer</p>
                                        <p className='text-justify text-lg pt-2'>A Diploma in Computer Applications (DCA) is a type of academic program that teaches computer applications and related skills. It is typically a short-term course that can be completed in six months.</p>
                                        <p className='text-justify fs-2 py-2 text-red-600'>DCA Job Opportunities</p>
                                        <p className='text-justify text-lg pt-2'>The goal of a DCA program is to provide students with the knowledge and skills they need to use computers effectively in a variety of settings, including business, education, and personal efforts. Upon completing a DCA program, students may be able to pursue entry-level positions in fields such as data entry, customer service, or office administration. Some DCA graduates may also choose to continue their education by pursuing a bachelors degree in a related field, such as computer science or information technology.</p>
                                        <p className='text-justify fs-3 py-2 text-red-600  '>DCA Course Syllabus</p>
                                        ...
                                        <p className='text-justify text-lg pt-2'>Anyone can easily do this computer course online sitting at home.You can learn this course in Urdu language</p>
                                    </div>
                                </div>
                            </Col>
                        </Row>
                                ...
                                <div className="card rounded-3 shadow-lg">
                                    ...
                                    <div className="card-body space-y-3">
                                        <div className='flex space-x-2 fs-6 items-center'>
                                            <FontAwesomeIcon className='text-green-600 pe-3 fs-4' icon={faMoneyBill1} />Rs.0.00 <del className='pe-2' >Rs.4000</del> | <span className='text-red-500'>100% Off </span>
                                        </div>
                                        <div className='flex space-x-2 fs-6 items-center'>
                            ...
                            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 mx-3">
                                <div className="bg-white rounded-lg p-6 w-full max-w-md">
                                    ...
                                    <div className='text-lg pb-2 text-justify'>
                                        "Currently, there is no video available for this <i className='font-bold'>'DCA'</i> courses. It will be added soon. Thanks!  &#128522;"
                                    </div>
